...
```
It should be noted that all the model based regional estimates appear to be lie within the direct estimates confidence intervals except in the Bakool region. 
...
i) First, the raking benchmarking method iteratively adjusts district estimates until convergence is reached with the regional poverty rate. However, the FH model regional poverty rates are all within [X-X] percent of the direct estimates, as a result this had little effect in changing the district poverty rates. 
